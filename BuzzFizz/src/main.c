 ...
 *  @author Mark Allinder
 *  @date March 7, 2016
 *
 *  This program is a simple FizzBuzz variation which prints "Buzz", "Fizz",
 *  or "BuzzFizz" based on Fibonacci numbers.
 *
 *  A much simpler version of this program, without user input, unit testing,
 *  and Doxygen documentation, can be found at:
 *      https://gist.github.com/mcallinder/1ea8faa5f437a089e326
 *
 */
#include <ctype.h>
#include <stdint.h>
